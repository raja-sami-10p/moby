...
#TODO: This -v flag needs to be moved
DOCKER_FLAGS := docker run -v /var/tmp:/tmp --rm -i --privileged $(DOCKER_CONTAINER_NAME) $(DOCKER_ENVS) $(DOCKER_MOUNT) $(DOCKER_PORT_FORWARD)
